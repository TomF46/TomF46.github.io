    ...
    <div id="projects-page" class="projects page">
        ...
        <div class="row">
            <div
                ...
                :key="i"
                class="col-xs-12 col-sm-6 col-md-4 project-card"
            >
                <div class="row">
                    <div
                        class="col-xs-12"
                        @click="navigate(`/projects/${project.slug}`)"
                    >
                        <crossfade-image
                            :topImage="project.images[0].src"
                            :bottomImage="project.images[1].src"
                            :title="project.name"
                        />
                    </div>
                    <div class="col-xs-12">
                    ...
                    <div v-if="project.link != null" class="col-xs-12">
                        <a class="project-external-link" :href="project.link"
                            >Project website</a
                        >
                    </div>
